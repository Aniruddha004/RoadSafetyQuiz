...
public class ResultActivity extends AppCompatActivity {
    ...
    private final int NUMBER_OF_QUESTIONS = 15;
    private int score;
    ...
    private void FillTextPopUp() {
        if (correctAnswer >= 9) {
            ...
            score = 0;
            if (correctAnswer > 0)
                score = (correctAnswer * 100)/NUMBER_OF_QUESTIONS;
            scoreTextView.setText(score + "");

            outOfTextView.setText(String.format(getString(R.string.out_of), correctAnswer, NUMBER_OF_QUESTIONS));
        } else {
            Toast.makeText(this, "Score below 9.... Please try again", Toast.LENGTH_SHORT).show();
